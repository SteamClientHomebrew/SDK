...
//       } catch (e) {
//         console.warn("[Router] Navigation interface failed to call GetFocusedWindowInstance", e);
//       }
//       if (!win) {
//         console.warn("[Router] Navigation interface could not find any focused window. Falling back to Main Window Instance");
...
//         } catch (e) {
//           console.error("[Router] Navigation handler failed", e);
//         }
//       } else {
//         console.error("[Router] Navigation interface could not find a window to navigate");
//       }
//     }
//   }
//   const newNavigation = {
...
// } catch (e) {
//   console.error('[Router] Error initializing Navigation interface', e);
// }
